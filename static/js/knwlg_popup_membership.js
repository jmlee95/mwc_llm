...
function initKnowledgePopup() {
        ...
        try {
            ...
            switch(buttonId) {
                case 'knowledge1':
                    ...
                    break;
                case 'knowledge2':
                    title = 'KT Membership VIP Choice Benefits';
                    tabContents = [
                    ...
                    break;
                case 'knowledge3':
                    title = 'KT Membership Food Benefits';
                    tabContents = [
                        { name: 'Product Information', id: 'tab1' }
                    ];
                    contentsList = [
    ...
    if (knowledgeBtn2) {
        knowledgeBtn2.addEventListener('click', function (e) {
            ...
            loadKnowledgeContent(filePath, 'knowledge2');
        });
    }
    ...
    if (knowledgeBtn3) {
        knowledgeBtn3.addEventListener('click', function (e) {
            ...
            // 5G 슬림 요금제 영문 내용 로드
            const filePath = '/knwlgFile/03_membership/[KT 멤버십 제휴사] 모든등급 - 푸드 ver.2 [25.02.12].html';
            loadKnowledgeContent(filePath, 'knowledge3');
        });
    }
    ...
    if (tabListPopup.length > 0 && contentsPopup.length > 0) {
        for (let i = 0; i < tabListPopup.length; i++) {
            tabListPopup[i].querySelector('.btn').addEventListener('click', async function (e) {
                ...
                // switch(tabId) {
                //     case '1':
                //         filePath = '/knwlgFile/03_membership/[KT 멤버십 제휴사] 모든등급 - 푸드 ver.2 [25.02.12].html';
                //         break;
                //     case '2':
                //         filePath = '/knwlgFile/03_membership/[KT 멤버십 제휴사] VIP 혜택 - VIP 초이스 ver.2 [25.02.20].html';
                //         break;
                //     case '3':
                //         filePath = '/knwlgFile/03_membership/KT 멤버십 제휴사 ver.6 [25.02.14].html';
                //         break;
                // }
