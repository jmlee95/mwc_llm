...
function initKnowledgePopup() {
   ...
   async function loadKnowledgeContent(filePath, buttonId) {
    try {
        ...
        switch(buttonId) {
            case 'knowledge1':
                title = 'Our Family Wireless Connection';
                tabContents = [
                    { name: 'Product Information', id: 'tab1'},
                    { name: 'manual', id: 'tab2'},
                    { name: 'FAQ', id: 'tab3'}
                ];
                contentsList = [
            ...
            button.addEventListener('click', async function(e) {
                ...
                if (targetContent) {
                    ...
                    if (buttonId === 'knowledge1') {
                        switch(tabId) {
                            case '1':
                                contentPath = '/knwlgFile/02_combine/우리가족 무선결합(구. 우리가족 무선할인) ver.2 [24.10.24]`_상품정보.html';
                                break;
                            case '2':
                                contentPath = '/knwlgFile/02_combine/우리가족 무선결합(구. 우리가족 무선할인)_매뉴얼.html';
                                break;
                            case '3':
                                contentPath = '/knwlgFile/02_combine/우리가족 무선결합(구. 우리가족 무선할인_FAQ.html';
                                break;
                        }
    ...
    if (knowledgeBtn1) {
        knowledgeBtn1.addEventListener('click', function (e) {
            ...
            // 5G 슬림 요금제 영문 내용 로드
            const filePath = '/knwlgFile/02_combine/우리가족 무선결합(구. 우리가족 무선할인) ver.2 [24.10.24]`_상품정보.html';
    ...
    //         const filePath = '/knwlgFile/03_membership/[KT 멤버십 제휴사] VIP 혜택 - VIP 초이스 ver.2 [25.02.20].html';
    ...
    //         // 5G 슬림 요금제 영문 내용 로드
    //         const filePath = '/knwlgFile/03_membership/KT 멤버십 제휴사 ver.6 [25.02.14].html';
    //         loadKnowledgeContent(filePath);
    //     });
    // }
    ...
    //             switch(tabId) {
    //                 case '1':
    //                     filePath = '/knwlgFile/02_combine/우리가족 무선결합(구. 우리가족 무선할인) ver.2 [24.10.24]`_상품정보.html';
    //                     break;
    //                 case '2':
    //                     filePath = '/knwlgFile/02_combine/우리가족 무선결합(구. 우리가족 무선할인)_매뉴얼.html';
    //                     break;
    //                 case '3':
    //                     filePath = '/knwlgFile/02_combine/우리가족 무선결합(구. 우리가족 무선할인_FAQ.html';
    //                     break;
    //             }
