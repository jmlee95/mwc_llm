...
var audioMap = {
	'AI_GENIE_1': '/static/audio/2/F/2-1_consultant_01.mp3',
	'AI_GENIE_2': '/static/audio/2/F/2-1_consultant_02.mp3',
	'AI_GENIE_3': '/static/audio/2/F/2-1_consultant_03.mp3',
	'AI_GENIE_4': '/static/audio/2/F/2-1_consultant_04.mp3',
	'AI_GENIE_5': '/static/audio/2/F/2-1_consultant_05.mp3',
	'CUSTOMER_1': '/static/audio/2/F/2-1_customer_01.mp3',
	'CUSTOMER_2': '/static/audio/2/F/2-1_customer_02.mp3',
	'CUSTOMER_3': '/static/audio/2/F/2-1_customer_03.mp3',
	'CUSTOMER_4': '/static/audio/2/F/2-1_customer_04.mp3'
};

var maleAudioMap = {
	'AI_GENIE_1': '/static/audio/2/M/2-2_consultant_01.mp3',
	'AI_GENIE_2': '/static/audio/2/M/2-2_consultant_02.mp3',
	'AI_GENIE_3': '/static/audio/2/M/2-2_consultant_03.mp3',
	'AI_GENIE_4': '/static/audio/2/M/2-2_consultant_04.mp3',
	'AI_GENIE_5': '/static/audio/2/M/2-2_consultant_05.mp3',
	'CUSTOMER_1': '/static/audio/2/M/2-2_customer_01.mp3',
	'CUSTOMER_2': '/static/audio/2/M/2-2_customer_02.mp3',
	'CUSTOMER_3': '/static/audio/2/M/2-2_customer_03.mp3',
	'CUSTOMER_4': '/static/audio/2/M/2-2_customer_04.mp3'
};
...
// 답변 생성하기 버튼 클릭 이벤트 수정
		...
		if (answerMakerBtn) {
			...
			await typeWriter(tab1, answers.answer2_1, 10);
...
// 답변하기 버튼 클릭 이벤트 수정
		...
		if (answerBtn) {
			...
			// 고객 응답 추가
			await createAndPlayMessage(false, "How much is the discount for the \"Family Wireless Bundle\"?", 'CUSTOMER_2', chatArea);
			await new Promise(resolve => setTimeout(resolve, 1000));
...
async function streamMessages() {
	try {
		const response = await fetch('/api/stream_message2');
